...
import classes from "./privacePolice.module.css";
  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <p>
            Your privacy is important to us. It is  <b>Lunacat Ivan Marzan</b>'s policy
            ...
            you, including via our app,  <b>Lunacat Ivan Marzan</b>, and its associated
            ...
            you leave our app. This policy is effective as of June 1, 2024. Last
        ...
        <div>
          ...
          <p>
            ...
            information you knowingly and actively provide us when using our app
            and its associated services. “Automatically collected” information
            refers to any information automatically sent by your device in the
        ...
        <div>
          ...
          <p>
            ...
            details about your usage. Additionally, when you encounter certain
            errors while using the app, we automatically collect data about the
            error and the circumstances surrounding its occurrence. This data
            may include technical details about your device, what you were
            ...
            occurred, or what the nature of the error is. Please be aware that
            while this information may not be personally identifying by itself,
            it may be possible to combine it with other data to personally
            identify individual persons.
          </p>
          <p>Third parties we currently use include:</p>
          <ul>
            <li>Google Analytics</li>
            <li>https://api.mixpanel.com</li>
            <li>Freshdesk (https://msdk.eu.freshchat.com)</li>
            <li>Adapty (https://adapty.io)</li>
            <li>RevenueCat (https://revenuecat.com)</li>
            <li>Sentry (https://sentry.io)</li>
            <li>Flurry (https://yahoo.com)</li>
            <li>MailChimp</li>
        ...
        <div>
          ...
          <p>
            ...
            United States, and Ireland, or where we or our partners, affiliates,
        ...
        <div>
          ...
          <p>
            ...
            may affect your use of our app or the products and/or services
          ...
          <p>
            ...
            particular service or offer (for example serving particular content
            to your device), we will not deny you goods or services and/or
        ...
        <div>
          ...
          <p>
            <b>Data Controller / Data Processor</b>
          </p>
          <p>
            ...
            organizations (known as “data processors”). We,  <b>Lunacat Ivan Marzan</b>,
          ...
          <p>
            <b>Performance of a Contract or Transaction</b>
          </p>
          <p>
          ...
          <p>
            ...
            For example, we collect technical information about your device in
            order to improve and personalize your experience of our app. We
          ...
          <p>
            <b>Restrict:</b> You have the right to request that we restrict the
          ...
          <p>
            <b>Objecting to processing:</b> You have the right to object to
          ...
          <p>
            <b>Data portability:</b> You may have the right to request a copy of
          ...
          <p>
            <b>Deletion:</b> You may have a right to request that we delete the
            ...
            your account, we will delete your personal information within 14
        ...
        <div>
          ...
          <p>
            <b>CCPA-permitted financial incentives</b>
          </p>
          <p>
          ...
          <p>
            <b>California Notice of Collection</b>
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            decision. If you have concern about your PII being misused, or if
            you want further information about our <u>Privacy Policy</u> and
            what it means, please feel free to email us at{" "}
            <a href="mailto: ivan.marzan.1986@gmail.com">
              ivan.marzan.1986@gmail.com
            </a>
            , we will endeavor to provide clear answers to your questions in a
            timely manner.
          </p>
        </div>
      </Container>
